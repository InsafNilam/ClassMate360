            ...
            <div className="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
                ...
                <div className="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3 relative z-10">
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                        ...
                                        >
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed text-justify">
                                                    ...
                                                    with ClassMate360, the
                                                    ultimate solution for
                                                    seamless student management.
                                                    Say goodbye to paperwork,
                                                    endless spreadsheets, and
                                                    administrative hassles. With
                                                    our intuitive platform,
                                                    streamline your academic
                                                    processes and focus on what
                                                    truly matters – providing
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            ...
                                            our platform is easy to navigate for
                                            users of all technical backgrounds.
                                            platform can scale to meet your
                                            needs.
                                        </p>
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Access detailed profiles for every
                                            student, including academic records,
                                            attendance history, and personal
                                            details, all in one centralized
                                            location.
                                        </p>
                                    </div>
                                ...
                                <div className="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800">
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        ...
                                        <p className="mt-4 text-sm/relaxed">
                                            Rest assured knowing that sensitive
                                            student data is protected with
                                            state-of-the-art security measures.
                                            Our platform ensures compliance with
